...
SECRET_KEY = 'django-insecure-4q79135fegam!nfs&xvjf^u=^s-u_jw^1pal+^h$)guh1%1-zb'
...
MIDDLEWARE = [
    ...
    # 'django.middleware.csrf.CsrfViewMiddleware',  # ⬅️ DISABLED for development
...
# Database - Keep SQLite for Django's built-in features (sessions, auth, admin)
# MongoDB will be used for your ExpenseModel via MongoEngine
DATABASES = {
    'default': {
